...
#include "new_interface/action/detail/move_robot__rosidl_typesupport_fastrtps_c.h"
...
#include "new_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _MoveRobot_Goal__ros_msg_type = new_interface__action__MoveRobot_Goal;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_Goal(
  const void * untyped_ros_message,
...
static uint32_t _MoveRobot_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = new_interface__action__MoveRobot_Goal;
    is_plain =
      (
...
static size_t _MoveRobot_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Goal)() {
...
using _MoveRobot_Result__ros_msg_type = new_interface__action__MoveRobot_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_Result__ros_msg_type * ros_message = static_cast<const _MoveRobot_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_Result;
    is_plain =
      (
...
static size_t _MoveRobot_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Result)() {
...
using _MoveRobot_Feedback__ros_msg_type = new_interface__action__MoveRobot_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_Feedback__ros_msg_type * ros_message = static_cast<const _MoveRobot_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_Feedback;
    is_plain =
      (
...
static size_t _MoveRobot_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Feedback)() {
...
// already included above
// #include "new_interface/action/detail/move_robot__functions.h"  // goal
...
const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Goal)();
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_new_interface
...
using _MoveRobot_SendGoal_Request__ros_msg_type = new_interface__action__MoveRobot_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _MoveRobot_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_new_interface__action__MoveRobot_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_new_interface__action__MoveRobot_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_SendGoal_Request;
    is_plain =
      (
...
static size_t _MoveRobot_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_SendGoal_Request)() {
...
using _MoveRobot_SendGoal_Response__ros_msg_type = new_interface__action__MoveRobot_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _MoveRobot_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_SendGoal_Response;
    is_plain =
      (
...
static size_t _MoveRobot_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_SendGoal_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_SendGoal)() {
...
using _MoveRobot_GetResult_Request__ros_msg_type = new_interface__action__MoveRobot_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_GetResult_Request__ros_msg_type * ros_message = static_cast<const _MoveRobot_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_GetResult_Request;
    is_plain =
      (
...
static size_t _MoveRobot_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_GetResult_Request)() {
...
// already included above
// #include "new_interface/action/detail/move_robot__functions.h"  // result
...
using _MoveRobot_GetResult_Response__ros_msg_type = new_interface__action__MoveRobot_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_GetResult_Response__ros_msg_type * ros_message = static_cast<const _MoveRobot_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_new_interface__action__MoveRobot_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_new_interface__action__MoveRobot_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_GetResult_Response;
    is_plain =
      (
...
static size_t _MoveRobot_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_GetResult_Response)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_GetResult)() {
...
// already included above
// #include "new_interface/action/detail/move_robot__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _MoveRobot_FeedbackMessage__ros_msg_type = new_interface__action__MoveRobot_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t get_serialized_size_new_interface__action__MoveRobot_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveRobot_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _MoveRobot_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_new_interface__action__MoveRobot_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_new_interface__action__MoveRobot_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_new_interface
size_t max_serialized_size_new_interface__action__MoveRobot_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_new_interface__action__MoveRobot_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = new_interface__action__MoveRobot_FeedbackMessage;
    is_plain =
      (
...
static size_t _MoveRobot_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_new_interface__action__MoveRobot_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, new_interface, action, MoveRobot_FeedbackMessage)() {
